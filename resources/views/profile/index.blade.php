            ...
            <div class="card">
                ...
                <div class="card -container">
                        ...
                        <tbody>
                            @foreach ($profiles as $profile)
                                <tr>
                                    ...
                                    <td><a class="btn btn-info bg-orange" href="{{route('profile.show', $profile->id)}}">
                                    ...
                                    <td>
                                        @can('haveaccess','ownprofile.destroy')
                                            <form action="{{route('profile.destroy', $profile->id)}}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="btn btn-danger bg-orange ">
                    ...
                    <a href="{{url()->previous()}}" class="btn btn-secondary bg-orange" role="button" >Volver</a>
                      ...
                      <a href="{{route('profile.create')}}" class="btn btn-success bg-orange">Crear Perfil</a>
                        @endcan
                </div>
